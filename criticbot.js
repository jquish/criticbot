...
if (str.includes('NOUN')) { str = mlf.replace_nouns(str); }
if (str.includes('ADJ')) { str = mlf.replace_adjs(str); }
if (str.includes('VERB')) { str = mlf.replace_verbs(str); }
if (str.includes('ADVB')) { str = mlf.replace_advbs(str); }
if (str.includes('CELEB')) { str = mlf.replace_celebs(str); }
if (str.includes('INTJ')) { str = mlf.replace_intjs(str); }
if (str.includes('GEN')) { str = mlf.replace_gens(str); }
if (str.includes('MOOD')) { str = mlf.replace_moods(str); }
if (str.includes('OBJ')) { str = mlf.replace_objs(str); }
if (str.includes('OCC')) { str = mlf.replace_occs(str); }
if (str.includes('MOV')) { str = mlf.replace_movs(str); }
if (str.includes('SOD')) { str = mlf.replace_sods(str); }
